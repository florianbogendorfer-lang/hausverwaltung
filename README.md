...
(FR-HITL-6). Freigabepflichtige Tools (`nachricht_senden`,
`dienstleister_beauftragen`, `rechnung_erfassen`) sind bewusst noch nicht
aktiv — die Freigabe-Queue (propose/commit) kommt erst in Phase 3.

**Noch nicht enthalten** (spätere Phasen laut §16): HITL-Freigabe-Queue,
Web-GUI, echte RAG-Vektorsuche (Phase 2 nutzt eine einfache Stichwortsuche
als Platzhalter), echter Mail-Adapter.
